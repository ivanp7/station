...
#define STATION_APP_ERROR_LIBRARY       (STATION_APP_ERROR_BASE +  6) ///< Error: couldn't load shared library.
#define STATION_APP_ERROR_SIGNAL        (STATION_APP_ERROR_BASE +  7) ///< Error: couldn't configure signal management.
#define STATION_APP_ERROR_THREADS       (STATION_APP_ERROR_BASE +  8) ///< Error: couldn't create concurrent processing context.
#define STATION_APP_ERROR_OPENCL        (STATION_APP_ERROR_BASE +  9) ///< Error: couldn't create OpenCL context.
#define STATION_APP_ERROR_SDL           (STATION_APP_ERROR_BASE + 10) ///< Error: couldn't initialize SDL subsystems.
